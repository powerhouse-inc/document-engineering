...
interface TooltipProps extends TooltipPrimitiveProps, Omit<TooltipContentProps, 'content'> {
  content: React.ReactNode
  className?: string
  triggerAsChild?: boolean
}

const TooltipContent = React.forwardRef<React.ElementRef<typeof Content>, TooltipContentProps>(
...
const Tooltip: React.FC<TooltipProps> = ({
  ...
  return (
    <Root defaultOpen={defaultOpen} delayDuration={delayDuration} onOpenChange={onOpenChange} open={open}>
      <Trigger
