...
const meta: Meta<typeof Tooltip> = {
  ...
  argTypes: {
    ...
    className: {
      description: 'Additional CSS/Tailwind classes to apply to the tooltip content',
      control: 'text',
    },
    align: {
...
export const Alignments: Story = {
  render: () => (
    <div>
      <div className="mb-8 text-center text-lg font-medium">Tooltip alignments</div>
...
export const DifferentSides: Story = {
  render: () => (
    <div>
      <div className="mb-8 text-center text-lg font-medium">Tooltip side positions</div>
      <div className="flex items-center justify-center gap-32">
