...
import { PlaceHolderRecord } from './placeholder-record.js'
...
const PreviewAudioPreview = ({ status, onClose = () => null, preview, className }: AudioPreviewProps) => {
  ...
  return <PlaceHolderRecord status={status} onClose={onClose} className={cn('w-full h-full', className)} />
}

export default PreviewAudioPreview
