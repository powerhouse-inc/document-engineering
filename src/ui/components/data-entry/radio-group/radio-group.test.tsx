...
describe('RadioGroup Component', () => {
  ...
  it('should have aria-label when no label is provided', () => {
    render(<RadioGroup name="radio-group" options={[{ label: 'Option 1', value: '1' }]} />)
    const radioGroup = screen.getByRole('radiogroup')
  ...
  it('should use provided id when specified', () => {
    render(<RadioGroup id="custom-id" name="radio-group" options={[{ label: 'Option 1', value: '1' }]} />)
    const radioGroup = screen.getByRole('radiogroup')
    expect(radioGroup).toHaveAttribute('id', 'custom-id')
  })

  it('should handle required state', () => {
    render(<RadioGroup name="radio-group" label="Group Label" required options={[{ label: 'Option 1', value: '1' }]} />)
    const radioGroup = screen.getByRole('radiogroup')
