...
export const mockedOptions: PHIDOption[] = [
  ...
  },
  {
    ...
    description: 'Comprehensive marketing initiatives and campaign planning for 2024',
  },
  {
    icon: 'PowerhouseLogoSmall',
    ...
    description: 'Technical documentation of system components and infrastructure',
  },
  {
    icon: 'PowerhouseLogoSmall',
  ...
  },
  {
    ...
    value: 'phd://sustainability.powerhouse.io/baefc2a4-f9a0-4950-8161-fd8d8ca8eff7',
...
const filterOptions = (options: PHIDOption[], userInput: string, context?: Record<string, unknown>) => {
...
// Sync versions
export const fetchOptionsSync = (userInput: string, context?: Record<string, unknown>): PHIDOption[] => {
  return filterOptions(mockedOptions, userInput, context)
}
