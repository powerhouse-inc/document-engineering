...
- Amount: [buildAmountCellEditor](#buildamountcelleditor)
...
### `buildAmountCellEditor`

Creates an amount input editor using the `AmountField` component.

**Equivalent scalar:** [AmountField](/docs/scalars-components-amount-field--docs)

```tsx
import { buildAmountCellEditor } from '@powerhousedao/document-engineering/table'

// Basic usage
renderCellEditor: buildAmountCellEditor({})
