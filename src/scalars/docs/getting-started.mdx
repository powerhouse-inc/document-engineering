...
Each Scalar component is a React component meticulously designed to correspond to a specific GraphQL scalar type. This direct mapping simplifies the development of forms that align with your `Connect` document schema – simply choose the Scalar component that matches your data type.
