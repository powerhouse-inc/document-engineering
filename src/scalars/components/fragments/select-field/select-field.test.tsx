...
describe('SelectField Component', () => {
  ...
  it('should match snapshot', () => {
    const { asFragment } = renderWithForm(<SelectField name="select" options={defaultOptions} />)
    expect(asFragment()).toMatchSnapshot()
  })

  it('should render with custom placeholder', () => {
    renderWithForm(<SelectField name="select" options={defaultOptions} placeholder="Custom placeholder" />)
    expect(screen.getByText('Custom placeholder')).toBeInTheDocument()
  })

  // Label Tests
  it('should render with label', () => {
    renderWithForm(<SelectField name="select" options={defaultOptions} label="Test Label" />)
    expect(screen.getByText('Test Label')).toBeInTheDocument()
  })

  it('should show required indicator when required', () => {
    renderWithForm(<SelectField name="select" options={defaultOptions} label="Test Label" required />)
  ...
  it('should show search input when searchable is true', async () => {
    const user = userEvent.setup()
    renderWithForm(<SelectField name="select" options={defaultOptions} searchable />)
  ...
  it('should display warning messages', () => {
    renderWithForm(<SelectField name="select" options={defaultOptions} warnings={['Please review your selection']} />)
  ...
  it('should handle value when provided', () => {
    renderWithForm(<SelectField name="select" options={defaultOptions} value="2" />)
  ...
  it('should have correct ARIA attributes', async () => {
    renderWithForm(
      <SelectField name="select" options={defaultOptions} label="Test Label" required errors={['Error message']} />
    )
  ...
  it('should allow multiple selections when multiple is true', async () => {
    ...
    renderWithForm(<SelectField name="select" options={defaultOptions} onChange={onChangeMock} multiple />)
