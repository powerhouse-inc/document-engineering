...
describe('RadioGroupField Component', () => {
  ...
  it('should have aria-label when no label is provided', () => {
    renderWithForm(<RadioGroupField name="radio-group" options={[{ label: 'Option 1', value: '1' }]} />)
    const radioGroup = screen.getByRole('radiogroup')
  ...
  it('should use provided id when specified', () => {
    renderWithForm(<RadioGroupField id="custom-id" name="radio-group" options={[{ label: 'Option 1', value: '1' }]} />)
    const radioGroup = screen.getByRole('radiogroup')
  ...
  it('should handle required state', () => {
    renderWithForm(
      <RadioGroupField name="radio-group" label="Group Label" required options={[{ label: 'Option 1', value: '1' }]} />
    )
    const radioGroup = screen.getByRole('radiogroup')
