...
const TestInputRaw = ({ onChange, onBlur, value = '', name = 'test' }: InputProps) => {
  return <input data-testid="test-input" onChange={onChange} onBlur={onBlur} value={value} name={name} />
}
...
describe('ValueTransformer', () => {
  ...
  it('should handle array of transformer functions', () => {
    const { getByTestId } = render(
      <TestWrapper>
        <ValueTransformer transformers={[(value?: string) => value?.trim(), (value?: string) => value?.toUpperCase()]}>
          <TestInput name="test" />
        </ValueTransformer>
      </TestWrapper>
    )
  ...
  it('should preserve original event handlers', async () => {
    ...
    const { getByTestId } = render(
      <TestWrapper>
        ...
        >
          <TestInput onChange={onChangeMock} onBlur={onBlurMock} name="test" value="" />
        </ValueTransformer>
      </TestWrapper>
    )
