...
describe('TextareaField Component', () => {
  ...
  it('should handle basic props and attributes', () => {
    renderWithForm(
      <TextareaField name="textarea" label="Test Label" required disabled multiline rows={5} spellCheck={true} />
    )
  ...
  describe('Input Handling', () => {
    it('should handle various input methods and transformations', async () => {
      ...
      renderWithForm(<TextareaField name="textarea" value="Initial" maxLength={20} uppercase />)
