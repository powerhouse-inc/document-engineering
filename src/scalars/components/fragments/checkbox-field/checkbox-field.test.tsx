...
describe('CheckboxField', () => {
  ...
  it('should render with description icon', () => {
    renderWithForm(<CheckboxField name="test" label="Test checkbox" description="This is a description" />)
    expect(screen.getByTestId('icon-fallback')).toBeInTheDocument()
  })

  it('should handle checked state', () => {
    const handleChange = vi.fn()
    renderWithForm(<CheckboxField name="test" label="Test checkbox" value={false} onChange={handleChange} />)
