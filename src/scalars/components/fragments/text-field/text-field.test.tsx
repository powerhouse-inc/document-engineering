...
describe('TextField', () => {
  it('should match snapshot', () => {
    const { container } = renderWithForm(<TextField name="test" label="Test Label" />)
  ...
  it('should render with initial value', () => {
    renderWithForm(<TextField name="name" label="Name" value="John Doe" onChange={() => null} />)
    expect(screen.getByDisplayValue('John Doe')).toBeInTheDocument()
  })

  it('should render with default value', () => {
    renderWithForm(<TextField name="name" label="Name" defaultValue="John Doe" />)
    expect(screen.getByDisplayValue('John Doe')).toBeInTheDocument()
  })
  ...
  it('should display warning messages', () => {
    renderWithForm(<TextField name="name" label="Name" warnings={['Name is too long']} />)
  ...
  it('should display character counter when maxLength is provided', () => {
    renderWithForm(<TextField name="name" label="Name" value="John" maxLength={10} onChange={() => null} />)
    expect(screen.getByText('4')).toBeInTheDocument()
    expect(screen.getByText('/10')).toBeInTheDocument()
  })

  it('should display character counter with empty value when maxLength is provided', () => {
    renderWithForm(<TextField name="name" label="Name" value="" maxLength={11} onChange={() => null} />)
