...
describe('FormLabel Component', () => {
  it('should match snapshot', () => {
    const { asFragment } = render(<FormLabel data-testid="form-label">label</FormLabel>)
  ...
  it('should display an icon when description is provided', () => {
    render(<FormLabel description="This is a description">Label with Description</FormLabel>)
