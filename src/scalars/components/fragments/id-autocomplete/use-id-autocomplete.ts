...
export function useIdAutocomplete({
  ...
  const [options, setOptions] = useState<IdAutocompleteOption[]>(initialOptions ?? [])
  ...
  const [selectedOption, setSelectedOption] = useState<IdAutocompleteOption | undefined>(undefined)
