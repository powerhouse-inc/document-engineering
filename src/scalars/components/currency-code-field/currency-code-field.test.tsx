...
describe('CurrencyCodeField', () => {
  ...
  it('should render with default props', () => {
    renderWithForm(<CurrencyCodeField name="currency" label="Currency" currencies={currencies()} />)
  ...
  it('should show an error if trying to submit empty with required enabled', async () => {
    ...
    renderWithForm(
      <>
        <CurrencyCodeField name="currency" label="Currency" required currencies={currencies()} />
  ...
  it('should submit the currency code', async () => {
    ...
    render(
      <Form onSubmit={onSubmit}>
        <CurrencyCodeField name="currency" label="Currency" value="USD" currencies={currencies()} />
        <button type="submit">Submit</button>
      </Form>
    )
    await user.click(screen.getByText('Submit'))
  ...
  it('should handle disabled state', () => {
    renderWithForm(<CurrencyCodeField name="currency" label="Currency" disabled currencies={currencies()} />)
    expect(screen.getByRole('combobox')).toBeDisabled()
  })

  it('should display custom errors', async () => {
    const errors = ['Please select a valid currency']
    renderWithForm(<CurrencyCodeField name="currency" label="Currency" errors={errors} currencies={currencies()} />)
  ...
  it('should display custom warnings', async () => {
    ...
    renderWithForm(<CurrencyCodeField name="currency" label="Currency" warnings={warnings} currencies={currencies()} />)
