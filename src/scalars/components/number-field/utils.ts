...
const floatTypes: NumericType[] = ['NegativeFloat', 'PositiveFloat', 'NonNegativeFloat', 'NonPositiveFloat', 'Float']

const formatValue = (value: string, precision?: number, trailingZeros?: boolean) => {
...
export function getDisplayValue(value?: string, transformProps?: TransformProps) {
  if (!value) return ''
